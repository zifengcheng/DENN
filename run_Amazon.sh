...
for ((seed=0; seed<1; ++seed)); do
    ...
    python test.py --random_seed $seed --dataset_name Amazon --root ../DataSet/Amazon --setting F --alpha ${alpha} --temp ${temp} --k ${k} --gpu 0,1,2,3 --batch_size 128 --thresh ${threshold}
done
